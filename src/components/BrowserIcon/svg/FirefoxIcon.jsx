...
const FirefoxIcon = ({ size }) => (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" height={size} width={size}>
		<defs>
			<radialGradient
				id="firefoxA"
				cx="-14480.522"
			...
			<radialGradient
				...
				cy="-6516.556"
				r="266.886"
				gradientTransform="matrix(1.219 .123 -.123 1.219 10296.265 9597.23)"
				gradientUnits="userSpaceOnUse"
			>
			...
			<radialGradient id="firefoxH" cx="691.339" cy="3.289" r="923.615" gradientUnits="userSpaceOnUse">
			...
			<linearGradient
				...
				y1="-1082.012"
				y2="-1221.859"
				gradientTransform="matrix(.995 .1 -.1 .995 -173.696 1313.941)"
				gradientUnits="userSpaceOnUse"
			>
			...
			<linearGradient
				...
				y1="718.827"
				y2="825.714"
				gradientTransform="rotate(5.73 2610.90224439 2923.84488778)"
				gradientUnits="userSpaceOnUse"
			>
		...
		<path
			fill="url(#firefoxA)"
			d="M805.285 93.558c-23.947 27.884-35.1 90.639-10.818 154.256s61.5 49.8 84.7 114.673c30.623 85.6 16.369 200.589 16.369 200.589s36.814 106.609 62.468-6.633c56.783-212.703-152.719-410.506-152.719-462.885Z"
		/>
		<path
			fill="url(#firefoxB)"
			d="M513.072 976.638c245.236 0 443.9-199.739 443.9-446.028S758.308 84.583 513.31 84.583 69.65 284.322 69.65 530.61c-.475 246.527 198.423 446.028 443.422 446.028Z"
		/>
		<path
			fill="url(#firefoxC)"
